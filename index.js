...
const token = '7123684153:AAEEjAUrTpgb-Vya0ENfiQ4BpflITVuRNXI';
...
bot.on('message', (msg) => {
  ...
  if (command.startsWith('/spidi')) {
    ...
    if (args.length === 5 && url && time && thread && rate) {
      ...
      bot.sendMessage(chatId, 'Format pesan tidak benar. Gunakan format: /spidi [url] [time] [thread] [rate]');
    }
  }
});
